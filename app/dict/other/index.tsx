              ...
              <Form layout="horizontal" labelCol={{ span: 3 }} wrapperCol={{ span: 16 }}>
                <Form.Item label="选择字典类型: ">
                  <Select
                    ...
                    options={[
                      {
                        value: StringConst.dictTextbookOtherType,
                        label: "题型",
                      },
                      {
                        value: StringConst.dictTextbookOtherTag,
                        label: "标签",
                      },
                    ]}
                  />
          ...
          <Splitter.Panel defaultSize="50%" resizable={false}>
            <div className="p-3">
              <Form layout="horizontal" labelCol={{ span: 3 }} wrapperCol={{ span: 16 }}>
                ...
                <Form.Item>
                  <Button color="primary" variant="dashed" onClick={onAddClick}>
                    添加
                  </Button>
                </Form.Item>
              </Form>
