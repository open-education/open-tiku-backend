...
export default function Edit(props: any) {
  ...
  const edit = () => {
    ...
    // 提交到路由对应的 action
    fetcher
      .submit({id: item.id, label, code, sortOrder}, {method: "post"})
      .then((r) => {
      });
  };
  ...
  return (
    <div className="border-4 border-indigo-50 pl-8 pr-8 pt-4 pb-4">
      <Flex vertical gap={16}>
        <div>
          <Typography.Title level={4}>编辑科目</Typography.Title>
        </div>
        ...
        <div className="mt-1.5">
          <Button
            ...
            onClick={edit}
          >
            {fetcher.state === "submitting" ? "编辑中..." : "编辑"}
          </Button>
        </div>
      </Flex>
    </div>
