...
export default function Append(props: any) {
  ...
  const onChapterNameChange = useCallback((e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => {
    if (setChapterName) {
  ...
  return (
    <div className="mt-4">
      <Splitter style={{ minHeight: 80, boxShadow: "0 0 10px rgba(0, 0, 0, 0.1)" }}>
              ...
              <Row gutter={[12, 12]}>
                <Col span={24}>
                  <Form layout="horizontal" labelCol={{ span: 2 }} wrapperCol={{ span: 8 }}>
                    ...
                    <Form.Item>
                      <Button color="primary" variant="dashed" onClick={props.appendChapterName}>
                        追加
                      </Button>
                    </Form.Item>
                  </Form>
