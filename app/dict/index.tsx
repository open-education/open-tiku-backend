import { Layout, Menu, Spin, theme, type MenuProps } from "antd";
...
export default function Index(props: any) {
  ...
  let leftMenuItems: MenuProps["items"] = [
    {
      key: "subject",
      label: <NavLink to={"subject"}>科目</NavLink>,
    },
    {
      key: "publisher",
      label: <NavLink to={"publisher"}>出版社</NavLink>,
    },
    {
      key: "stage",
      label: <NavLink to={"stage"}>学段</NavLink>,
    },
    {
      key: "tag",
    ...
    {
      key: "question_type",
      label: <NavLink to={"question_type"}>题型</NavLink>,
    },
  ];
